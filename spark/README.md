...
- 목차
  * [1. :green_book: 실습환경 준비](#1-실습을-위한-코드를-준비-합니다)
...
- 정답
  * [1. :green_book:/:blue_book: 시작 노트북](http://htmlpreview.github.io/?https://github.com/psyoblade/ssm-seoul-data-engineer/blob/master/notebooks/html/data-engineer-training-course.html)
  * [2. :green_book:/:blue_book: 정답 노트북](http://htmlpreview.github.io/?https://github.com/psyoblade/ssm-seoul-data-engineer/blob/master/notebooks/html/data-engineer-training-course-answer.html)
...
#### 1-3-1. 현재 기동된 컨테이너를 확인합니다
```bash
# terminal
docker ps -a
```

#### 1-3-2. 기동된 컨테이너가 있다면 강제 종료합니다
```bash
# terminal 
